 ...
 <ul>
  ...
  <li><a href="keyword.html"><i class="theme"></i><em>关键字</em></a></li>
    ...
    <div id="dcMain">
        ...
        <h3><a href="addbookview.html?rec=add" class="actionBtn add">添加书评</a>书评列表</h3>
            ...
            <form name="action" method="post" action="#">
                <table width="100%" border="0" cellpadding="8" cellspacing="0" class="tableBasic">
                    <tr>
                        ...
                        <th width="80" align="center">图书ID</th>
                        <th align="center">书评标题</th>
                        <th width="100" align="center">书评类型</th>
                        <th width="150">书评状态</th>
                        <th width="80" align="center">用户ID</th>
                    ...
                    <tr>
                        ...
                        <td align="center">
                            <a href="editbookview.html">编辑</a> | <a href="#">删除</a>
                        </td>
                    </tr>
                    <tr>
                        <td align="center"><input type="checkbox" name="checkbox[]" value="15" /></td>
